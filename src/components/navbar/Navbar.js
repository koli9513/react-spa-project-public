    ...
    <div>
      ...
      >
        ...
        <div style={navLinkContainerStyle}>
          <StyledNavbarLink to="/" style={navLinkStyle}>
            Home
          </StyledNavbarLink>
          <StyledNavbarLink to="/browse" style={navLinkStyle}>
            Browse books
          </StyledNavbarLink>
          <StyledNavbarLink style={navLinkStyle} to="/favorites">
            Favorites
          </StyledNavbarLink>
          <StyledNavbarLink style={navLinkStyle} to="/genres">
            Genres
          </StyledNavbarLink>
        </div>
        <CatGif cat="1" />
